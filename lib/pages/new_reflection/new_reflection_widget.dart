...
import 'new_reflection_model.dart';
export 'new_reflection_model.dart';
...
class _NewReflectionWidgetState extends State<NewReflectionWidget> {
  late NewReflectionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewReflectionModel());

    _model.titleTextController ??= TextEditingController();
    _model.titleFocusNode ??= FocusNode();

    _model.reflectionsTextController ??= TextEditingController();
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        if (_model.titleTextController.text != '') {
                          await SQLiteManager.instance.newJournalEntry(
                            title: _model.titleTextController.text,
                            reflections: _model.reflectionsTextController.text,
                          );
