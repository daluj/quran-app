                            ...
                            child: ExpandablePanel(
                              ...
                              expanded: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'The first four words in the Quran (the Basmalah) contain two of God\'s Beautiful Names. They are Al-Rahman and Al-Raheem. The meaning of Al-Raheem is \'The Merciful\'. It is often translated as \'The Most Merciful\'. However, the words for \'The Most Merciful\' are \'Arham Al-Rahimeen\' (see 7:151, 12:64, 12:92, 21:83)\n\nAs for Al-Rahman, its translation has been inconsistent. The variation include: The Most Gracious, the Compassionate and the Beneficient. The words: merciful, gracious, compassionate and beneficient are all related to the attribute of mercy. \n\nHowever, when we examine various Quranic verses where the Name Al-Rahman is used, we cosistently find that they portray might and absolute power rather than mercy and compassion. ',
                                      textAlign: TextAlign.justify,
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        'Fear comes from the might of the Almighty rather than ther mercy of the Compassionate.',
                                                        textAlign:
                                                            TextAlign.justify,
                                                        style:
                                                            FlutterFlowTheme.of(
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        'The names Al-Rahman is used three times in the above verses. The heavens shatter, and the mountains crash in ruin in awe of Al-Rahman. This overwhelming awe is due to the attributes of mightiness and power rather than compassion and mercy.',
                                                        textAlign:
                                                            TextAlign.justify,
                                                        style:
                                                            FlutterFlowTheme.of(
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        'To be in the presence of Almighty God can only be as servants in total submission. This is due to the attribute of might and absolute power. An example is given in the story of Moses. (7:143)',
                                                        textAlign:
                                                            TextAlign.justify,
                                                        style:
                                                            FlutterFlowTheme.of(
