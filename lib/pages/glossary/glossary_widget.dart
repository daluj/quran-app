...
class _GlossaryWidgetState extends State<GlossaryWidget> {
  ...
  void initState() {
    ...
    _model.glossarySearchTextController ??= TextEditingController();
    _model.glossarySearchFocusNode ??= FocusNode();
  }
              ...
              children: [
                Row(
                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        controller: _model.glossarySearchTextController,
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: _model
                                  .glossarySearchTextController!.text.isNotEmpty
                              ? InkWell(
                                  onTap: () async {
                                    _model.glossarySearchTextController
                                        ?.clear();
                        ...
                        validator: _model.glossarySearchTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ],
                ...
                Flexible(
                  child: FutureBuilder<List<GetGlossaryRow>>(
                    future: SQLiteManager.instance.getGlossary(
                      translationCode: 'en',
                      searchText: _model.glossarySearchTextController.text,
                    ),
